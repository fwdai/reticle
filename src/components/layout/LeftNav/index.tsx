import { Radar, Home, Activity, LayoutDashboard, Layers, Settings } from "lucide-react";
...
function LeftNav({ currentPage, onNavigate }: LeftNavProps) {
  const navItems = [
    ...
    { id: "enviroments" as Page, icon: Layers, label: "Environments" },
  ...
  return (
    <TooltipProvider>
      <aside className="w-16 bg-nav-dark flex flex-col items-center py-6 flex-shrink-0 z-20 rounded-xl mr-1.5">
        <div className="mb-8">
