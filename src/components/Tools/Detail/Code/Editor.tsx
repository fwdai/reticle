  ...
  return (
    <>
      ...
      {hasNamedParameters ? (
        <div
          className={cn(
            "mt-2.5 rounded-md border overflow-hidden",
            argsError
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="text-[10px] font-semibold tracking-widest text-text-muted uppercase truncate">
                Arguments
              </span>
        ...
        <div className="mt-2.5 space-y-1.5">
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              title={argsErrorMessage ?? undefined}
              onKeyDown={(e) => {
          ...
          {argsErrorMessage ? (
            <p className="text-[11px] text-red-600">{argsErrorMessage}</p>
          ) : null}
        </div>
      )}

      {hasNamedParameters ? (
        <div className="mt-2 flex justify-end">{runButton}</div>
      ) : null}
